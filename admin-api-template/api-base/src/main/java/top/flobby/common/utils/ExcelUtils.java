...
import top.flobby.common.excel.ExcelDataListener;
...
public class ExcelUtils {
    ...
    public static <T> void excelExport(Class<T> head, String excelName, String sheetName, List<T> data) {
        try {
            ...
            EasyExcel.write(response.getOutputStream(), head).sheet(StrUtil.isBlank(sheetName) ? "sheet1" : sheetName).doWrite(data);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
